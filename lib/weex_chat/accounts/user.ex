defmodule WeexChat.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, WeexChat.Repo)
  ...
  """
  def valid_password?(%WeexChat.Accounts.User{hashed_password: hashed_password}, password)
